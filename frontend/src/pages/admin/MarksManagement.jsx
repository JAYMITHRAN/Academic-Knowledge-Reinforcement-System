// src/pages/admin/MarksManagement.jsx
import React, { useEffect, useState, useRef } from 'react';
import { listUsers, listCourses, adminUploadMarksheet, adminUpsertIndividualMark, getAdminDashboard } from '../../services/api';
    ...
    <AppLayout>
      <div style={{ maxWidth: '800px' }}>
        ...
        <p style={{ color: '#64748b', marginBottom: '32px', fontSize: '0.88rem' }}>
          Bulk import or individually manage student academic records
        </p>
